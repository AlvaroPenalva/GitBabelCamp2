...
@ComponentScan(basePackages = { "service", "dao" }) // escanea todas las clases que se encuentren con la anotacion service para instanciarlas
...
public class ServiceConfig {
	...
	// adaptador de Hibernate
		...
		public LocalContainerEntityManagerFactoryBean factory(DataSource dataSource, HibernateJpaVendorAdapter adapter) {
			...
			factory.setPersistenceUnitName("Formacion");
